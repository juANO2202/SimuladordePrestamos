...
export const generateCreditPdf = (simulationData, userName) => {
  ...
  // Columna 2 (X = 78) - Ajustado espacio para evitar solapamiento con Columna 3
  ...
  // Columna 3 (Resumen Totales, X = 138)
  doc.setFont('helvetica', 'bold');
  doc.setTextColor(15, 23, 42);
  ...
  // Tabla de Amortización Completa (7 columnas)
  currentY += 45;
