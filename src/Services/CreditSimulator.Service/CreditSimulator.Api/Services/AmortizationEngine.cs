...
namespace CreditSimulator.Api.Services
{
    ...
    public class AmortizationEngine : IAmortizationEngine
    {
        ...
        {
            // Tasa Efectiva Anual (TEA) a Tasa Efectiva Mensual: i_mensual = (1 + TEA)^(1/12) - 1
            ...
            decimal desgravamenRate = 0.0006m; // 0.06% mensual sobre saldo deudor
            ...
            {
                // Método Francés: Cuota base mensual fija
            ...
            {
                // Método Alemán: Capital constante por mes = P / n
